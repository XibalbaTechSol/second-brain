    ...
    <div className="bg-card border border-border rounded-3xl p-8 shadow-sm">
      <div className="flex items-center justify-between mb-8">
        <h3 className="text-lg font-bold flex items-center gap-2 text-foreground">
          <Calendar className="w-5 h-5 text-aurora-orange" /> Calendar
          Integration
        </h3>
        <div className="bg-aurora-green/10 text-aurora-green text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-tighter">
          Connected
        </div>
      </div>
        ...
        <div className="bg-muted/30 rounded-[2rem] p-8 border border-border flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group">
          ...
          <div className="bg-white dark:bg-background p-6 rounded-[2rem] shadow-xl border border-border">
            <svg viewBox="0 0 24 24" className="w-12 h-12">
              <path
                fill="#4285F4"
                d="M22.5 12c0-.8-.1-1.5-.2-2.2H12v4.3h5.9c-.3 1.4-1 2.5-2.2 3.3v2.7h3.5c2.1-1.9 3.3-4.7 3.3-8.1z"
              />
              <path
                fill="#34A853"
                d="M12 23c2.9 0 5.4-1 7.2-2.7l-3.5-2.7c-1 .7-2.3 1.1-3.7 1.1-2.8 0-5.2-1.9-6.1-4.5H2.3v2.8C4.1 20.2 7.8 23 12 23z"
              />
              <path
                fill="#FBBC05"
                d="M5.9 14.2c-.2-.7-.3-1.4-.3-2.2s.1-1.5.3-2.2V7H2.3C1.5 8.5 1 10.2 1 12s.5 3.5 1.3 5l3.6-2.8z"
              />
              <path
                fill="#EA4335"
                d="M12 5.3c1.6 0 3 .5 4.1 1.6l3.1-3.1C17.4 2.1 14.9 1 12 1 7.8 1 4.1 3.8 2.3 7l3.6 2.8c.9-2.6 3.3-4.5 6.1-4.5z"
              />
            </svg>
          </div>

          <div className="flex-1 text-center md:text-left relative z-10">
            <h4 className="text-2xl font-black italic tracking-tight mb-2 text-foreground">
              Google Calendar
            </h4>
            <p className="text-muted-foreground text-sm font-medium mb-6">
              Synchronize your behavioral nudges and goals with your primary
              calendar.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-card border border-border rounded-2xl space-y-4">
            ...
            <p className="text-[11px] text-muted-foreground font-medium italic">
              New strategic nudges will automatically appear as events.
            </p>
          </div>
          ...
          <div className="p-6 bg-card border border-border rounded-2xl space-y-4">
            ...
            <p className="text-[11px] text-muted-foreground font-medium italic">
              Schedule weekly audits to review knowledge graph momentum.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="p-6 bg-muted/30 rounded-2xl border border-border">
          ...
          <div className="flex gap-3">
            ...
            >
              {generating
                ? "Generating..."
                : settings.infraApiKey
                  ? "Regenerate"
                  : "Generate Key"}
            </button>
          </div>
          <p className="text-[9px] text-muted-foreground mt-4 leading-relaxed tracking-wide uppercase font-bold opacity-60">
            Use this key to programmatically capture data from external scripts,
            webhooks, or server-side integrations.
          </p>
        </div>

        <div className="space-y-4">
          <h4 className="text-sm font-bold text-foreground ml-1 uppercase tracking-widest opacity-60">
            Sample Request
          </h4>
      ...
      <div className="bg-primary rounded-[2rem] p-8 text-primary-foreground relative overflow-hidden mb-8 shadow-xl shadow-primary/20">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            ...
            {sub.tier === "FREE" && (
              <span className="text-sm font-medium italic text-white/90">
                Active Free Trial
              </span>
            )}
          </div>
          <h4 className="text-3xl font-black mb-2 italic tracking-tight">
            Cognito {sub.tier === "FREE" ? "Pro" : sub.tier}
          </h4>
          <p className="opacity-80 text-sm mb-6">
            Full access to behavior-changing AI reasoning engine.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {sub.tier !== "FREE" && (
          <div className="bg-muted/30 rounded-2xl p-6 border border-border flex flex-col justify-between">
            <div>
              <h4 className="font-bold text-foreground mb-1 uppercase text-xs tracking-widest opacity-60">
                Status
              </h4>
...
function AISettings() {
  ...
  if (loading)
    return (
      <div className="text-center py-20 text-muted-foreground italic font-medium">
        Loading synaptic configuration...
      </div>
    );
    ...
    <div className="bg-card border border-border rounded-3xl p-8 shadow-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-muted-foreground mt-2 ml-1 italic font-medium">
        ...
        <div className="pt-6 border-t border-border flex justify-end gap-4 items-center">
          {settings.aiProvider === "OLLAMA" && (
            <span className="text-[10px] font-bold text-aurora-orange uppercase tracking-tighter bg-aurora-orange/10 px-2 py-1 rounded">
    ...
    <div className="max-w-4xl mx-auto p-8 pt-12">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground mt-2">
          Manage your brain's configuration and subscription.
        </p>
      </div>
