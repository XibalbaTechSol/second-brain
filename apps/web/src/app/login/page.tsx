      ...
      <div className="w-full max-w-md space-y-10 relative">
        ...
        <Link href="/" className="flex flex-col items-center gap-4 group">
          ...
          <div className="text-center">
            <span className="font-black text-4xl text-foreground tracking-tighter italic">
              CognitoFlow
            </span>
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground mt-1 opacity-60">
              Intelligence Engine
            </p>
          </div>
        </Link>
        ...
        <div className="bg-card border border-border p-10 rounded-[3rem] shadow-2xl shadow-primary/5 backdrop-blur-sm transition-colors">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-2 font-medium text-sm">
              Access your active second brain instance.
            </p>
          </div>
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-[10px] uppercase">
              <span className="bg-card px-4 text-muted-foreground font-black tracking-[0.3em]">
                Synaptic Link
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center gap-6">
          <p className="text-center text-muted-foreground text-sm font-medium">
            ...
            <Link
              href="/"
              className="text-primary hover:underline font-black italic"
            >
              Start trial
            </Link>
          </p>
