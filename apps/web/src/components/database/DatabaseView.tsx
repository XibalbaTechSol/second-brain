...
const MOCK_DATA = [
  {
    ...
    status: "In Progress",
    created: "10/24/2023",
    content: "<h3>Project Alpha</h3><p>Detailed notes for Alpha...</p>",
  },
  {
    id: "2",
    name: "Personal Goals",
    ...
    status: "Not Started",
    created: "10/25/2023",
    content: "<h3>Personal Goals</h3><ul><li>Goal 1</li><li>Goal 2</li></ul>",
  },
  {
    id: "3",
    name: "Q4 Review",
    ...
    status: "Done",
    created: "10/26/2023",
    content: "<h3>Q4 Review</h3><p>Everything went well.</p>",
  },
];
...
export const DatabaseView: React.FC<DatabaseViewProps> = ({
  ...
  const [viewMode, setViewMode] = useState<"table" | "crm">(
    viewType === "PERSON" ? "crm" : "table",
  );
  ...
  const handleCreateRow = async () => {
    ...
    try {
      ...
      setData((prev) =>
        prev.map((r) => (r.id === newId ? { ...r, id: saved.id } : r)),
      );
    } catch (error) {
      ...
      <div className="px-5 py-3 border-b border-border flex items-center justify-between bg-background z-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2 text-sm text-muted-foreground">
            <button className="hover:text-foreground transition-colors px-2 py-1 hover:bg-muted rounded-md">
              Sort
            </button>
            <button className="hover:text-foreground transition-colors px-2 py-1 hover:bg-muted rounded-md">
              Filter
