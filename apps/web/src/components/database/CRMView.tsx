            ...
            >
              ...
              <div className="space-y-1 mb-6">
                ...
                <p className="text-xs text-muted-foreground font-medium">
                  {person.metadata?.person?.role || "No Role"} @{" "}
                  {person.metadata?.person?.company || "Freelance"}
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-xs text-muted-foreground pt-2 border-t border-border mt-4">
                  ...
                  <span>
                    Last contact:{" "}
                    {person.metadata?.person?.lastContacted
                      ? formatToMMDDYYYY(person.metadata.person.lastContacted)
                      : "Never"}
                  </span>
                </div>
              </div>
