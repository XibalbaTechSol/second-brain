...
const INITIAL_NODES = [
  ...
  // Project Path
  {
    ...
    data: {
      ...
      promptTemplate:
        'Analyze for "Bias towards Action". Find the smallest 10-minute step.',
    },
  },
  {
    id: "p2",
  ...
  // Idea Path
  {
    ...
    data: {
      ...
      promptTemplate:
        "If this idea were 10x more ambitious, what would it look like?",
    },
  },
  {
    id: "i2",
    ...
    (event: React.DragEvent) => {
      ...
      const newNode = {
        ...
        data: {
          ...
          promptTemplate:
            type === "reasoning"
              ? "Analyze this input and extract key insights..."
              : undefined,
          events: [],
        },
      };
        ...
        setNodes((nds) =>
          nds.map((node) => {
            ...
            if (node.type === "trigger") {
              ...
              const targetType = nodeData.actionType
                ?.replace("create_", "")
                .toUpperCase();
              ...
              relevantLogs = logs
                .filter((l: any) => {
                  ...
                  return (
                    l.action === "WORKFLOW_EXECUTED" &&
                    l.details.toUpperCase().includes(targetType || "UNKNOWN")
                  );
                })
                .map((l: any) => ({
        ...
        <div className="p-4 space-y-8 overflow-y-auto custom-scrollbar">
          <div className="space-y-3">
            ...
            {[
              ...
              >
                <div
                  className={`p-2 rounded-xl bg-muted/30 group-hover:scale-110 transition-transform ${trigger.color}`}
                >
                  ...
                  <div className="space-y-6 p-6 bg-muted/30 rounded-[2rem] border border-border">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="ai_nudge">
                          AI Coach Strategy (Reasoning)
                        </option>
                      </select>
                    </div>
                    ...
                    {editData.actionType === "ai_nudge" ? (
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <option value="Be extremely provocative and challenge the user's assumptions about this.">
                            Provocative/Challenger
                          </option>
                          <option value="Focus on immediate practical next steps and low-hanging fruit.">
                            Practical/Action-Oriented
                          </option>
                          <option value="Connect this to broader long-term vision and potential impact.">
                            Visionary/Big Picture
                          </option>
                          <option value="Identify potential risks or hidden complexities in this idea.">
